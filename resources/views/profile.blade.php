...
@section('content')
    <section class="hero is-medium is-primary is-bold" style="background: url('../images/default_cover.jpg')">
        <div class="hero-body">
            <div class="container">
            </div>
        </div>
        ...
        <div class="container">
            <div class="columns">
                <div class="column is-3">
                    <img class="is-circle profile-pic" src="/images/default_avatar.png" alt="Image">
                </div>
